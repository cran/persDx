np_lpd_cov2=function(D,YA,YB,Xq,X,cov.idx,p,
      ...
      for(q in 1:Q){
        for(a in 1:(A+1)){
          ...
          res2[[k]]=data.frame(r=r,q=q,a=a,
                               np_lpd_cov2_comp(D,YA,YB,Xq[[q]],X[,r],THETA0[q],ALPHA0[[r]][a]), n)
        }
      }
    }
  }
...
np_lpd_cov2_comp=function(D,YA,YB,Xq,Xr,alpha0q,alpha0r, n){
  ...
  return(data.frame(beta0=beta0.hat,beta1=beta1.hat,beta2=beta2.hat,AUC=AUC.max))
}
