...
np_lpd_survival_cov2=function(D,YA,YB,Xq,Xr,alpha0q,alpha0r,Stime,predict.time,span){
  ...
  for(j in 1:n.unq){ #compute subgroup AUC at each j with two direction
    ...
    AUC.pt[j]=np_lpd_cov2_survival_subauc(D,YA,YB,Xq,Xr,alpha0q,alpha0r,beta0,beta1.pt,beta2,Stime,predict.time,span)

    beta1.nt=-1 #when beta2=-1
    AUC.nt[j]=np_lpd_cov2_survival_subauc(D,YA,YB,Xq,Xr,alpha0q,alpha0r,beta0,beta1.nt,beta2,Stime,predict.time,span)
  }
